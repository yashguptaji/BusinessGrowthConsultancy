document.write(`<div class="container-fluid bg-dark text-light mt-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex  align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        <a href="index.html" class="navbar-brand">
                            <h1 class="m-0 text-white"><img src="img/logo.png" width=100% height=100%></h1>
                        </a>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">488, Sector 40, Gurgaon</p>
                            </div>
                            <div class="d-flex mb-2">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">+91 9810 625 129</p>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5 " style="margin-left: 100px;"  >
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                ...
                                <a class="text-light mb-2" href="service.html#process"><i class="bi bi-arrow-right text-primary me-2"></i>Process Strengthening</a>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Business Growth Consultancy</a>. All Rights Reserved. 
                    </div>
                </div>
            </div>
        </div>
